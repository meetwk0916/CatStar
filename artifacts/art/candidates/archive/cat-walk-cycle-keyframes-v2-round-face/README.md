...
At the time, this candidate replaced the previous runtime walk compromise. It
keeps an 8-frame gait while preserving the round visible face that users
preferred in the 6-frame baseline.
...
This was selected as a runtime walk candidate because it balanced:
