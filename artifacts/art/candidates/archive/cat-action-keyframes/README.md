...
The assembled sheets served as an interim visual baseline because they were
more coherent than the older runtime stopgap and avoided code-drawn cat art.
They are still not final production animation.

The assessment at the time called for manually cleaning the action sheets:
