...
- Dedicated walk-cycle keyframe candidate: `docs/art/candidates/cat-walk-cycle-keyframes/cat-walk-cycle-keyframes-01-alpha.png`
...
- Runtime `walk` uses the dedicated candidate under `docs/art/candidates/cat-walk-cycle-keyframes/`.
