...
- Current action sheets are generated by `scripts/generate_cat_animation_assets.py` according to `docs/CAT_ANIMATION_SPEC.md`.
- Replace generated technical sheets with hand-authored sprite sheets or atlas before final product art lock.
