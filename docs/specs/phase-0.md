...
>
> This document records the original pure-code Phase 0 direction. It no longer
> defines the current runtime architecture. For current implementation
> requirements, use [`phase-0.1.md`](./phase-0.1.md). Domain language and product
> boundaries remain governed by [`../../CONTEXT.md`](../../CONTEXT.md) and
> [`../../AGENTS.md`](../../AGENTS.md).
