...
The first migration is only floor-to-food-bowl. Scripted jumps, plant routines,
and **主动靠近** stay in their existing implementation until a second route
demonstrates shared needs. This decomposition must not become general
