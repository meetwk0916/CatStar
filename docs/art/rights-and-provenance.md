...
provider, model/version, account owner, applicable terms, and commercial-use
evidence were not recorded when the candidate images were created. That is an
incomplete rights chain, not proof of production rights.
